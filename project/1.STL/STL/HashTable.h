...
namespace STL {
	...
	template<class Key,class T,class KeyOfData,class Code = default_Code<Key>,class Equal= default_equal<Key>,class Allocator=CMP::TCMemAllocator>
	class HashTable {
	public:
	...
	template<class Key, class T, class KeyOfData, class Code = default_Code<Key>, class equal = default_equal<Key>,class Allocator =CMP::TCMemAllocator>
	void swap(HashTable<Key, T, KeyOfData, Code, equal,Allocator>& HT1, HashTable<Key, T, KeyOfData, Code, equal,Allocator>& HT2) {
		HT1.swap(HT2);
	}
